-- 0018_add_order_is_takeaway.sql

ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS is_takeaway BOOLEAN DEFAULT false;
...
BEGIN
  ...
  -- Insert order
  INSERT INTO public.orders (user_id, status, pickup_time, otp_code, is_takeaway)
  VALUES (v_user_id, 'PLACED', p_pickup_time, v_otp, p_is_takeaway)
