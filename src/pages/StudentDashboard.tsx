...
export default function StudentDashboard() {
  ...
  return (
    <div className="w-full max-w-4xl grid grid-cols-12 gap-4">
      {/* Header */}
      <div className="col-span-12 bg-white border border-slate-200 rounded-[2rem] p-5 sm:p-8 flex flex-col justify-between shadow-sm relative overflow-hidden mb-4">
      ...
      {menuLoading ? (
        ...
        <>
          {/* Menu */}
          <div className="col-span-12 lg:col-span-8 bg-white border border-slate-200 rounded-[2rem] p-5 sm:p-8 shadow-sm">
          ...
          {/* Cart */}
          <div className="col-span-12 lg:col-span-4 bg-slate-900 rounded-[2rem] p-5 sm:p-8 text-white flex flex-col shadow-sm">
